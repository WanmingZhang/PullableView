...
//    [label release];
    ...
    pullUpView = [[TnShortcutPullableView alloc] initWithFrame:CGRectMake(xOffset, 0, self.view.frame.size.width, self.view.frame.size.height)];
    pullUpView.backgroundColor = [UIColor greenColor];
...
//    [label release];
    ...
    pullDownView = [[TnShortcutPullableView alloc] initWithFrame:CGRectMake(xOffset, 0, 320, 460)];
